...
class _FirstPageState extends State<FirstPage>
  ...
  Future<List<UpcomingM>> _upVideo() async {
    ...
    var info1 = jsonData1['results'];
    for (var u in info1) {
      UpcomingM v = UpcomingM(u["title"], u["poster_path"], u["overview"],
          u["release_date"], u["id"], u["backdrop_path"], u["popularity"]);
      up.add(v);
    }
    return up;
  }
        ...
        child: Row(
          ...
          children: <Widget>[
            Text(
              text,
              style: TextStyle(
                  fontSize: 22, color: Colors.white, letterSpacing: 1.4),
            ),
            Icon(
              Icons.chevron_right,
              color: Colors.white,
