...
class _PeopleSearchPageState extends State<PeopleSearchPage> {
  ...
  Future<List<People>> _getPeopleSearch(String s) async {
    var data1 = await http.get(
        "https://api.themoviedb.org/3/search/person?api_key=$apiKey&language=en-US&query=$s&page=1&include_adult=false");
                                                                    ...
                                                                    Padding(
                                                                        ...
                                                                        child: Divider(
                                                                            ...
                                                                            color:
                                                                                Colors.grey)),
                                                                    Text(
                                                                      " Profession :  ${snapshot.data[index].known_for_department}",
                                                                      style:
                                                                          searchStyleContent,
                                                                    ),
                                                                    Text(
                                                                      " Popularity :  ${snapshot.data[index].popularity.toString()}",
                                                                      style:
                                                                          searchStyleContent,
                                                                    ),
                                                                  ],
