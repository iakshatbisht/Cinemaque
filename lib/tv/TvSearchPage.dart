import 'package:cinemaque/constants.dart';
...
class _TvSearchPageState extends State<TvSearchPage> {
  ...
  Future<List<TvAttributes>> _getTvSearch(String s) async {
    var data1 = await http.get(
        "https://api.themoviedb.org/3/search/tv?api_key=$apiKey&language=en-US&query=$s&page=1");
    var jsonData1 = json.decode(data1.body);
    var info1 = jsonData1["results"];
    for (var u in info1) {
      TvAttributes v = TvAttributes(u["name"], u["overview"], u["backdrop_path"], u["poster_path"],
                                                            ...
                                                            children: <Widget>[
                                                              ...
                                                              Padding(
                                                                  ...
                                                                  child: Divider(
                                                                      ...
                                                                      color: Colors
                                                                          .black12)),
                                                              searchContent(snapshot.data[index].overview),
                                                            ],
                                                          ),
                                                        ),
                                                      ),
