...
class _TvReviewPageState extends State<TvReviewPage>
  ...
  Future<List<CastDetail>> _cast() async {
    var data1 = await http.get(
        "https://api.themoviedb.org/3/tv/${widget.id}/credits?api_key=$apiKey&language=en-US");
  ...
  Future<List<TvAttributes>> _tvVideo() async {
    var data1 = await http.get(
        "https://api.themoviedb.org/3/tv/${widget.id}/similar?api_key=$apiKey&language=en-US&page=1");
    var jsonData1 = json.decode(data1.body);
    var info1 = jsonData1['results'];
    for (var u in info1) {
      TvAttributes t = TvAttributes(u["name"], u["overview"],
                    ...
                    onPressed: () {
                      if (pressed == false) {
                        ...
                        setState(() {
                          ...
                          ic1 = Icon(Icons.favorite_border,
          ...
          Row(
            children: <Widget>[
              Padding(
                ...
                child: Container(
                  height: 120, //80, for one plus
                  width: 170, //130, for one plus
                  child: Image.network(
