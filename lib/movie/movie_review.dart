...
class _MovieReviewState extends State<MovieReview>
  ...
  Future<List<CastDetail>> _cast() async {
    var data1 = await http.get(
        "https://api.themoviedb.org/3/movie/${widget.id}/credits?api_key=$apiKey");
  ...
  Future<List<SimilarM>> _simVideo() async {
    var data1 = await http.get(
        "https://api.themoviedb.org/3/movie/${widget.id}?api_key=$apiKey&append_to_response=similar");
    var jsonData1 = json.decode(data1.body);
        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              ...
              Padding(
                padding: const EdgeInsets.only(right: 50, bottom: 5, left: 10),
                child: Container(
                  child: Text(
                    widget.popularity.toString(),
                    style: TextStyle(
