...
class _PeoplePageState extends State<PeoplePage>
  ...
  Future<List<People>> _getPeople() async {
    ...
    var data2 = await http.get(
        "https://api.themoviedb.org/3/person/popular?api_key=$apiKey&language=en-US&page=2");
    var data3 = await http.get(
        "https://api.themoviedb.org/3/person/popular?api_key=$apiKey&language=en-US&page=3");
