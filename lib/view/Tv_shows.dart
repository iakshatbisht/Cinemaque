...
class _TvshowsState extends State<Tvshows>
  ...
  Future<List<TvAttributes>> _getTvShows() async {
    ...
    var data2 = await http.get(
        "https://api.themoviedb.org/3/tv/on_the_air?api_key=$apiKey&language=en-US&page=2");
    var data3 = await http.get(
        "https://api.themoviedb.org/3/tv/on_the_air?api_key=$apiKey&language=en-US&page=3");
